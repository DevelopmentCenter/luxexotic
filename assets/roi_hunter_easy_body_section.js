...
(function() {
    ...
    if (facebookRemarketingActive) { // if customer has active facebook
        ...
        ourAmazingGlobalObject.rheasy_fbq('1991337537553037', 'PageView');

        if (ourAmazingGlobalObject.cartPage.active) {
            ourAmazingGlobalObject.rheasy_fbq('1991337537553037', 'AddToCart', ourAmazingGlobalObject.cartPage.facebookEventParams);
        } else if (ourAmazingGlobalObject.productPage.active) {
            ourAmazingGlobalObject.rheasy_fbq('1991337537553037', 'ViewContent', ourAmazingGlobalObject.productPage.facebookEventParams);
        }
    }
